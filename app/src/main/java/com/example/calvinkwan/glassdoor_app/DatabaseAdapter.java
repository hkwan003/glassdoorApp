...
public class DatabaseAdapter
{
    ...
    private static final String TAG = "DatabaseAdapter"; //used for logging database version changes
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_MESSAGE};
    ...
    public long insertRow(String task)
    {
        ...
        initialValues.put(KEY_MESSAGE, task);
    ...
    public boolean updateRow(long rowId, String task)
    {
        ...
        newValues.put(KEY_MESSAGE, task);
